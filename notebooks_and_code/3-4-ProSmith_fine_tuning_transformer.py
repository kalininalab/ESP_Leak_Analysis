...
from utils.datautils_me import SMILESProteinDataset
...
def get_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The method used to split the data",
    )
    parser.add_argument(
        "--train_dir",
        type=str,
...
setting = args.log_name + '_' + str(n_gpus) +'gpus_bs' + str(eff_bs) +'_'+str(args.learning_rate) +'_layers' + str(args.num_hidden_layers)+ str(args.split_method)
