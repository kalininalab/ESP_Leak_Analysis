...
def main(args):
    ...
    train_X, train_y = create_input_and_output_data(df_train,column=column_name)
    test_X, test_y = create_input_and_output_data(df_test, column=column_name)
    val_X, val_y = create_input_and_output_data(df_val, column=column_name)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="End to end Hyperparameter tuning and xgboost model training for train:test:val splits")
