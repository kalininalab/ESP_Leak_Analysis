...
def main(args):
    ...
    log_file = os.path.join(CURRENT_DIR, "..", "data", "Reports", f'Report_{len(split_number)}Splits_{split_method}{Data_suffix}.log')
    ...
    if len(split_number) == 2:
        ...
        logging.info(f"Report after splitting data by {split_method} split method and check for nan or null cells '\n'{result.to_string()}")
