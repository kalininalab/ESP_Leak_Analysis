...
# Setup logging
logging.basicConfig(filename='Hyperparameter_optimization_ESM1bts_and_ECFP_I1e_3S.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
np.save(join(CURRENT_DIR, "..", "data", "training_results_3S", "y_val_pred_xgboost_ESM1b_ts_ECFP_3S_I1e.npy"), bst_final.predict(dval))
np.save(join(CURRENT_DIR, "..", "data", "training_results_3S", "y_val_true_xgboost_ESM1b_ts_ECFP_3S_I1e.npy"), val_y)
np.save(join(CURRENT_DIR, "..", "data", "training_results_3S", "roc_auc_val_xgboost_ESM1b_ts_ECFP_3S_I1e.npy"), roc_auc_val)
np.save(join(CURRENT_DIR, "..", "data", "training_results_3S", "mcc_val_xgboost_ESM1b_ts_ECFP_3S_I1e.npy"), mcc_val)
np.save(join(CURRENT_DIR, "..", "data", "training_results_3S", "accuracy_val_xgboost_ESM1b_ts_ECFP_3S_I1e.npy"), accuracy_val)
np.save(join(CURRENT_DIR, "..", "data", "training_results_3S", "loss_val_xgboost_ESM1b_ts_ECFP_3S_I1e.npy"), loss_val)
...
# Save test results
np.save(join(CURRENT_DIR, "..", "data", "training_results_3S", "y_test_pred_xgboost_ESM1b_ts_ECFP_3S_I1e.npy"), bst_final.predict(dtest))
np.save(join(CURRENT_DIR, "..", "data", "training_results_3S", "y_test_true_xgboost_ESM1b_ts_ECFP_3S_I1e.npy"), test_y)
np.save(join(CURRENT_DIR, "..", "data", "training_results_3S", "roc_auc_test_xgboost_ESM1b_ts_ECFP_3S_I1e.npy"), roc_auc_test)
np.save(join(CURRENT_DIR, "..", "data", "training_results_3S", "mcc_test_xgboost_ESM1b_ts_ECFP_3S_I1e.npy"), mcc_test)
np.save(join(CURRENT_DIR, "..", "data", "training_results_3S", "accuracy_test_xgboost_ESM1b_ts_ECFP_3S_I1e.npy"), accuracy_test)
np.save(join(CURRENT_DIR, "..", "data", "training_results_3S", "loss_test_xgboost_ESM1b_ts_ECFP_3S_I1e.npy"), loss_test)
